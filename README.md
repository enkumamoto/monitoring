...
- Ansible (Provisionamento e Configuração)-🖥️ Serviços de Monitoramento e Observabilidade------ Prometheus (Coleta de métricas)
...
- Terraform >= 1.x
- Ansible >= 2.10
- Par de Chaves-SH (arquivo .pem)
- Variáveis de conta AWS com permissões administrativas
